...
func (apiClient *APIClient) doRequest(context microappCtx.ExecutionContext, url string, requestMethod string, rawToken string, payload interface{}) (interface{}, error) {
	apiURL := apiClient.BaseURL + url
...
func (apiClient *APIClient) DoPost(context microappCtx.ExecutionContext, requestString string, rawToken string, payload interface{}) (map[string]interface{}, error) {
...
func (apiClient *APIClient) DoDelete(context microappCtx.ExecutionContext, requestString string, rawToken string, payload interface{}) error {
